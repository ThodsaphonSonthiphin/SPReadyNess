...
- **Always create an ADR for every design decision** — one ADR per decision, the
  ...
  see `.claude/skills/.dev-workflows-shared/references/diagram-convention.md`, Rule 3. A
...
`.claude/skills/.dev-workflows-shared/references/diagram-convention.md` (Unicode box-drawing,
...
convention in `.claude/skills/.dev-workflows-shared/references/diagram-convention.md` (one
