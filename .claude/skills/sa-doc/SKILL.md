...
`.claude/skills/.dev-workflows-shared/scripts/fixtures/sa-model-bookstore.yaml` shows a
complete, clean model.

### 3. Validate — the gate

```
python .claude/skills/.dev-workflows-shared/scripts/validate_model.py SA-<project>/sa-model.yaml
```
...
- Diagrams follow `.claude/skills/.dev-workflows-shared/references/diagram-convention.md` —
...
```
python .claude/skills/.dev-workflows-shared/scripts/check_doc_provenance.py SA-<project>/SA-<project>.md SA-<project>/sa-model.yaml
```
...
```
python .claude/skills/.dev-workflows-shared/scripts/render_doc.py SA-<project>/SA-<project>.md --pdf
```
